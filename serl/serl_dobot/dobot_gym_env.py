...
This follows the high-level contract of serl_robot_infra.franka_env.FrankaEnv:
...
Notes:
- This environment is intentionally lightweight: it directly calls the Dobot
  SimpleApi and DobotGripper without an HTTP/ROS bridge.
- Cameras are optional; if not available, zero images are returned.
"""
